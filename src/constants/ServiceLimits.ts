export const ServiceLimits = {
  ...
  operationDefaultTimeout: 180000, // 3 min
  baseRetryDelay: 1000,
  maxRetryDelay: 10000,
  minRetryDelay: 5000,
  ...
  indexCacheFreshTTL: 60 * 60 * 1000,
  indexCacheStaleTTL: 4 * 60 * 60 * 1000,
  indexCacheMaxTTL: 24 * 60 * 60 * 1000,
  ...
  contextIntelligenceSlowAnalysisThreshold: 2000,
  contextIntelligenceKeyFilesLimit: 10,
  contextIntelligenceConcurrencyLimit: 10,
  symbolPrefetchConcurrency: 5,
  hashCalculationConcurrency: 15,
  contextAnalysisTimeBudgetMs: 8000,
  contextAnalysisMinHighQuality: 20,
  contextAnalysisHighQualityThreshold: 50,
  fileReadTimeoutMs: 3000,
  fileReadTimeoutPerKb: 50,
  fileReadMaxTimeoutMs: 10000,
  fileReadRetryCount: 1,
  fileReadRetryDelayMs: 200,
  ...
  readmeTimeoutDefault: 180000, // 3 min
