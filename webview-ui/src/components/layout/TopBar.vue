...
<template>
  ...
  <div
    ...
    class="bg-background flex items-center justify-between px-2 py-3 pl-3"
  ...
  <!-- Homepage Header (minimal, no back button, title, or border) -->
  <div v-if="isHomePage" class="bg-background flex items-center justify-end px-2 py-3">
